---
title: Style Guide
description: The Poly's house style, A to Z — names, places, punctuation, and everything in between.
published: true
date: 2026-09-22T20:00:00.000Z
tags: style, editing, copy
editor: markdown
dateCreated: 2026-09-22T20:00:00.000Z
---

> **How to use this guide:** Entries are alphabetical. Words in *italics* show example usage, and *e.g.* means “for example.” Use the jump bar below or the table of contents to get around. For the kickers that run above headlines, see [Kickers](/style-guide/kickers).
{.is-info}

**Jump to:** [0–9](#numbers) · [A](#a) · [B](#b) · [C](#c) · [D](#d) · [E](#e) · [F](#f) · [G](#g) · [H](#h) · [I](#i) · [J](#j) · [K](#k) · [L](#l) · [M](#m) · [N](#n) · [O](#o) · [P](#p) · [Q](#q) · [R](#r) · [S](#s) · [T](#t) · [U](#u) · [V](#v) · [W](#w) · [X](#x) · [Y](#y) · [Z](#z)

**Appendices:** [A · Athletic Facilities](#appendix-a-athletic-facilities) · [B · RPI Buildings](#appendix-b-rpi-buildings) · [C · Colleges](#appendix-c-colleges) · [F · Fraternities](#appendix-f-rpi-fraternities) · [G · Grammar](#appendix-g-grammar) · [S · Sororities](#appendix-s-rpi-sororities)

---

## 0–9 {#numbers}
### 15th Street footbridge {#footbridge}
...
### area codes
See [phone numbers](#telephone-numbers).
...
### Auxiliary Services
“The Office of Auxiliary Services is responsible for the Campus Card, Catering, Conference Services, Dining Services, Laundry, Parking & Transportation, and Vending Machines.” See Campus Card, meal plan, and [shuttles](#shuttles).
...
Exceptions when numbers are always prefered are dates, times, ages, percentages, monetary amounts, or in [recipes](#recipe). 
...
This building at the end of the [15th Street footbridge](#footbridge) houses the Department of Public Safety.
...
When pluralizing an acronym, do not use an apostrophe. Similarly, you do not need an apotrophe for references to a [decade](#decades).
...
### votes
When detailing the result of a vote, such as those from a Student Senate meeting, use [figure dashes](#figure-dash), identical to sports scores. List votes for, votes against, and abstentions. The exception is when all members vote the same, when the word *unanimous* is preferred to figures. 
...
| Facility | Usage |
| --- | --- |
| **’86 Field** | Use *’86 Field* in all references. This is the field in the center of campus. |
| **’87 Gym** | Use *’87 Gym* in all references. This was a class gift by the Class of 1887 on the 25th anniversary of their graduation from Rensselaer. |
| **Anderson Field** | Use *Anderson Field* in all references. This is the field next to North Lot. |
| **Armory** | Use *Armory* in all references. The full name of this building is the *Alumni Sports and Recreation Center*. Do not use the abbreviations *AS+RC* or *AS&RC* unless in direct quotes. |
| **Doris Robison Field** | The softball team plays on this field next to the *Armory*. Must specify “Doris” on each reference when discussing both baseball and softball. |
| **East Campus Athletic Village** | Use *East Campus Athletic Village* on the first reference, *ECAV* subsequently.<br>Use *East Campus Arena* on the first reference, *ECAV Arena* subsequently.<br>Use *East Campus Stadium* on the first reference, *ECAV Stadium* subsequently. |
| **Harkness Field** | Use *Harkness Field* in all references. This is the field and surrounding track adjacent to the Houston Field House. Its full name is the *Ned Harkness Track and Field*. |
| **Houston Field House** | Use *Houston Field House* on first reference and *Field House* subsequently. The full name of this building is the *Livingston W. Houston Field House*. |
| **Mueller Center** | Use *Mueller Center* in all references. This is the fitness center which is an annex off the north side of the Armory. It’s named in recognition of a gift by Nancy S. Mueller honoring her late husband, Glenn M. Mueller ’64. |
| **Renwyck Field** | Use *Renwyck Field* in all references. This field, next to Harkness Field, is home to the men’s and women’s soccer and women’s lacrosse team. |
| **Robison Gym** | Use *Robison Gym* in all references. This is the gym inside the Armory. |
| **Robison Field** | Use *Robison Field* in all references. Formerly known as the 17th Street Field, this field, located near Samaritan Hospital, is home to the baseball team. |
| **Robison Pool** | Use *Robison Pool* in all references. This is the pool which is an annex off the south side of the Armory. The full name is the *Doris and Ellis Robison Memorial Pool*. |
| **Sharp Hall Tennis Courts** | Use *Sharp Tennis Courts* on first reference. This court is home turf for the tennis teams. *Sharp Courts* may be used on subsequent references. |
| **Willie Stanton Field** | This is the field behind ECAV. |
...
| **41 Ninth Street** | Black Cultural Center, spell in full. [website](https://www.rpi.edu/dept/union/bsa/public_html/bcc.html) |
...
| First reference | Location | Subsequent references | Team |
| --- | --- | --- | --- |
| **Boston University** | Boston, Mass. | BU | Terriers |
| **Bowling Green State University** | Bowling Green, Ohio | Bowling Green | Falcons |
| **Brown University** | Providence, R.I. | Brown | Bears |
| **Carnegie Mellon University** | Pittsburg, Pa. | CMU | Tartans |
| **Clarkson University** | Potsdam, N.Y. | Clarkson | Golden Knights |
| **Colgate University** | Hamilton, N.Y. | Colgate | Red Raiders |
| **College of the Holy Cross** | Worcester, Mass. | Holy Cross | Crusaders |
| **Cornell University** | Ithaca, N.Y. | Cornell | Big Red |
| **Dartmouth College** | Hanover, N.H. | Dartmouth | Big Green |
| **Hamilton College** | Clinton, N.Y. | Hamilton | Continentals |
| **Harvard University** | Cambridge, Mass. | Harvard | Crimson |
| **Hudson Valley Community College** | Troy, N.Y. | HVCC | Vikings |
| **Massachusetts Institute of Technology** | Cambridge, Mass. | MIT | Engineers |
| **Michigan State University** | East Lansing, Mich. | MSU, Michigan State | Spartans |
| **Niagara University** | Lewiston, N.Y. | Niagara | Purple Eagles |
| **Princeton University** | Princeton, N.J. | Princeton | Tigers |
| **Providence College** | Providence, R.I. | Providence | Friars |
| **Quinnipiac University** | Hamden, C.T. | Quinnipiac | Bobcats |
| **Rochester Institute of Technology** | Rochester, N.Y. | RIT | Tigers |
| **Russell Sage College** | Troy, N.Y. | Sage, Sage College | Gators |
| **Siena College** | Loudonville, N.Y. | Siena | Saints |
| **Skidmore College** | Saratoga Springs, N.Y. | Skidmore | Thoroughbreds |
| **St. Lawrence University** | Canton, N.Y. | St. Lawrence | Saints |
| **Union College** | Schenectady, N.Y. | Union | Flying Dutchmen/women, Skating Dutchmen/women |
| **United States Military Academy** | West Point, N.Y. | Army | Cadets, Black Knights |
| **University at Albany** | Albany, N.Y. | SUNY Albany, UAlbany | Great Danes |
| **University of Massachusetts Amherst** | Amherst, Mass. | UMass Amherst | Minutemen/women |
| **University of Massachusetts Dartmouth** | Dartmouth, Mass. | UMass Dartmouth | Corsairs |
| **University of Massachusetts Lowell** | Lowell, Mass. | UMass Lowell, Lowell | Riverhawks |
| **University of New Hampshire, The** | Durham, N.H. | UNH | Wildcats |
| **University of Vermont, The** | Burlington, V.T | Vermont, UVM | Catamounts |
| **Vassar College** | Poughkeepsie, N.Y. | Vassar | Brewers |
| **William Smith College** | Geneva, N.Y. | William Smith | Herons |
| **Worcester Polytechnic Institute** | Worcester, Mass. | WPI | Engineers |
| **Yale University** | New Haven, C.T. | Yale | Bulldogs |
...
- See [quotation](#quotation-marks) for more, but punctuation normally goes inside quotes.
